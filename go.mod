...
require (
	...
	github.com/bool64/zapctxd v0.1.7
	...
	github.com/swaggest/swgui v1.4.0
...
require (
	...
	github.com/swaggest/jsonschema-go v0.3.22 // indirect
	github.com/swaggest/openapi-go v0.2.12 // indirect
